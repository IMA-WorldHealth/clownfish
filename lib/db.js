...
INSERT OR IGNORE INTO smtp (host, username, password, gdrive_folder_id, paused) VALUES
  ('mail.ima-data.com', 'retro@snisrdc.com', '584Ebp9@F9%cdn#XcL2jrfH*5Raef*Ut', '1ItVnTm7ZSTt3xrG2E-3tUONkn-7RuEbK', FALSE),
  ('mail.ima-data.com', 'pcima@ima-assp.org', '584Ebp9@F9%cdn#XcL2jrfH*5Raef*Ut', '1k_sx78qTAO-l7B5iBgkWtQN0agExP87u', FALSE),
  ('mail.ima-data.com', 'retro@ima-assp.org', '584Ebp9@F9%cdn#XcL2jrfH*5Raef*Ut', '19X9MM9jspTD3PnNphVoDma0LyQQ2hElU', FALSE);
`.trim();
...
process.on('exit', () => {
  debug('Closing SMTP connections.');
  db.prepare('UPDATE smtp SET active = FALSE;');
